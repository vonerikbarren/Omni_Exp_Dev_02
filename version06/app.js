...
function showWelcomeScreen() {
    ...
    welcomePanel.innerHTML = `
        <div style="text-align: center; max-width: 600px; padding: 40px;">
            <div style="font-family: 'Orbitron', sans-serif; font-size: 48px; font-weight: 900; color: rgba(80, 80, 90, 1); text-shadow: 0 0 30px rgba(255, 255, 255, 0.9), 0 0 60px rgba(200, 200, 210, 0.6); margin-bottom: 30px; animation: pulse 2s infinite;">
                Welcome to ⟐mniExp
            </div>
            <div style="font-family: 'Orbitron', sans-serif; font-size: 18px; color: rgba(100, 100, 110, 0.9); margin-bottom: 40px; line-height: 1.6;">
                Prepare for the transferring of your consciousness.
            </div>
            <button id="start-entrance" style="
                padding: 20px 60px;
                background: linear-gradient(135deg, rgba(180, 180, 190, 0.4), rgba(220, 220, 230, 0.4));
                ...
                box-shadow: 0 0 30px rgba(200, 200, 210, 0.5), 0 0 60px rgba(220, 220, 230, 0.4);
                transition: all 0.3s;
            ">
                ⟐mniSynx
            </button>
        ...
        <style>
            ...
            #start-entrance:hover {
                background: linear-gradient(135deg, rgba(200, 200, 210, 0.6), rgba(240, 240, 245, 0.6));
                box-shadow: 0 0 50px rgba(200, 200, 210, 0.7), 0 0 80px rgba(220, 220, 230, 0.6);
                transform: scale(1.1);
